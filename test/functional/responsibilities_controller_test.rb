...
class ResponsibilitiesControllerTest < ActionController::TestCase
  ...
  test "should create responsibility" do
    assert_difference('Responsibility.count') do
      post :create, responsibility: { description: @responsibility.description, name: @responsibility.name, organization_type: @responsibility.organization_type, positions: @responsibility.positions }
    end
  ...
  test "should update responsibility" do
    put :update, id: @responsibility, responsibility: { description: @responsibility.description, name: @responsibility.name, organization_type: @responsibility.organization_type, positions: @responsibility.positions }
    assert_redirected_to responsibility_path(assigns(:responsibility))
  end
